...
var o12222 = temp__5733__auto__;
var temp__5733__auto____$1 = (o12222["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o12223 = temp__5733__auto____$1;
return (o12223["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9459__auto__ = f;
return (o__9459__auto__["toString"]).call(o__9459__auto__);
} else {
return "";
}
}catch (e12224){var _ = e12224;
return "";
}});
...
try{var o__9459__auto___12307 = t;
(o__9459__auto___12307["cljs$lang$ctorPrWriter"]).call(o__9459__auto___12307,t,writer);
}catch (e12225){var __12308 = e12225;
}
...
var char_code = (function (){var o__9459__auto__ = (new String(char$));
return (o__9459__auto__["charCodeAt"]).call(o__9459__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9459__auto__ = String;
return (o__9459__auto__["fromCharCode"]).call(o__9459__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12226 = num_code;
switch (G__12226) {
case (1):
return (185);
...
var o__9459__auto__ = String;
return (o__9459__auto__["fromCharCode"]).call(o__9459__auto__,superscript_code);
});
/**
...
}catch (e12227){var _e__9473__auto__ = e12227;
return false;
}})())){
...
var vec__12228 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12228,(0),null);
...
var len__4736__auto___12319 = arguments.length;
var i__4737__auto___12320 = (0);
while(true){
if((i__4737__auto___12320 < len__4736__auto___12319)){
args__4742__auto__.push((arguments[i__4737__auto___12320]));

var G__12321 = (i__4737__auto___12320 + (1));
i__4737__auto___12320 = G__12321;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12233){
var vec__12234 = p__12233;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12234,(0),null);
...
var G__12322 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12323 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12322;
remaining_tokens = G__12323;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12231){
...
var vec__12239 = cljs.core.split_with((function (p1__12238_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12238_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12239,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12239,(1),null);
...
var vec__12245 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12245,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12245,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12325 = cljs.core.rest(remaining_tokens);
var G__12326 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12325;
name_tokens = G__12326;
continue;
} else {
...
var vec__12250 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12250,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12250,(1),null);
var vec__12253 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12253,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12253,(1),null);
var vec__12256 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12256,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12256,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12256,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12256,(3),null);
...
var vec__12261 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12261,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12261,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12261,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12261,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12261,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12261,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__12264 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12264,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12264,(1),null);
var vec__12267 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12267,(0),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12270 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12270) : devtools.munging.parse_fn_info_deep.call(null,G__12270));
})()));
}
} else {
return fn_info;
...
var G__12330 = (arity + (1));
var G__12331 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12271){
var vec__12272 = p__12271;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12272,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12272,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12275_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12275_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12276_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12276_SHARP_);
}),sorted_infos);
...
args__4742__auto__.push((arguments[i__4737__auto___12335]));
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12279){
var vec__12280 = p__12279;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12280,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12277){
var G__12278 = cljs.core.first(seq12277);
var seq12277__$1 = cljs.core.next(seq12277);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12278,seq12277__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12284__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12284__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12284__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12284__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12285 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12285,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12285,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12285,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12285,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12285,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12285,(5),null);
...
var o__9459__auto__ = f;
return (o__9459__auto__["getBasis"]).call(o__9459__auto__);
});
/**
...
}catch (e12289){var _e__9473__auto__ = e12289;
...
var G__12338 = (obj[cljs.core.first(path)]);
var G__12339 = cljs.core.rest(path);
obj = G__12338;
path = G__12339;
continue;
} else {
...
var _STAR_ = (function (accum,p__12290){
var vec__12291 = p__12290;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12291,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12291,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12294){
var vec__12295 = p__12294;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12295,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12295,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12295,(2),null);
...
var post_process = (function (p__12299){
var vec__12300 = p__12299;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12300,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12300,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12298_SHARP_){
return (obj[cljs.core.first(p1__12298_SHARP_)]);
}),sorted_matches);
