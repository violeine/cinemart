...
if((x instanceof cljs.core.Keyword)){
var G__27795 = spec;
var G__27796 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__27795,G__27796) : f.call(null,G__27795,G__27796));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__27797 = spec;
var G__27798 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__27797,G__27798) : f.call(null,G__27797,G__27798));
} else {
return x;
...
if(typeof x === 'number'){
var G__27799 = spec;
var G__27800 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__27799,G__27800) : f.call(null,G__27799,G__27800));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e27802){if((e27802 instanceof Error)){
var ___$1 = e27802;
return x;
} else {
throw e27802;
...
}catch (e27805){if((e27805 instanceof Error)){
var ___$1 = e27805;
return x;
} else {
throw e27805;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__27807,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27808__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__27810,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27811__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__27813,x){
var map__27814 = p__27813;
var map__27814__$1 = (((((!((map__27814 == null))))?(((((map__27814.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27814.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27814):map__27814);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27814__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
