...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__27121){
...
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27122__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__27126 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27126.cljs$core$IFn$_invoke$arity$1 ? fexpr__27126.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27126.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__27127 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27127.cljs$core$IFn$_invoke$arity$1 ? fexpr__27127.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27127.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__27128){
...
var request = map__27129__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27129__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
