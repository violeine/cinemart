...
var len__4736__auto___12042 = arguments.length;
var i__4737__auto___12043 = (0);
while(true){
if((i__4737__auto___12043 < len__4736__auto___12042)){
args__4742__auto__.push((arguments[i__4737__auto___12043]));

var G__12044 = (i__4737__auto___12043 + (1));
i__4737__auto___12043 = G__12044;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__12017_12045 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__12018_12046 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__12019_12047 = true;
var _STAR_print_fn_STAR__temp_val__12020_12048 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__12019_12047);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__12020_12048);

try{var _STAR_print_level_STAR__orig_val__12021_12049 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12022_12050 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12022_12050);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12021_12049);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__12018_12046);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__12017_12045);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq12016){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12016));
}));
...
var new_formatters = current_formatters.filter((function (p1__12024_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__12024_SHARP_)));
}));
...
var G__12025_12051 = f;
var target__9471__auto___12052 = G__12025_12051;
if(cljs.core.truth_(target__9471__auto___12052)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12025_12051)].join(''),"\n","target__9471__auto__"].join('')));
}

(target__9471__auto___12052["toString"] = (function (){
...
var G__12026_12053 = "%c%s";
var G__12027_12054 = "color:transparent";
var G__12028_12055 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__12026_12053,G__12027_12054,G__12028_12055) : f.call(null,G__12026_12053,G__12027_12054,G__12028_12055));
...
var args__4742__auto__ = [];
var len__4736__auto___12056 = arguments.length;
var i__4737__auto___12057 = (0);
while(true){
if((i__4737__auto___12057 < len__4736__auto___12056)){
args__4742__auto__.push((arguments[i__4737__auto___12057]));

var G__12058 = (i__4737__auto___12057 + (1));
i__4737__auto___12057 = G__12058;
continue;
} else {
}
break;
...
var vec__12033 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12033,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12033,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__12059__delegate = function (add_fmt,add_args){
...
var G__12059 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__12060__i = 0, G__12060__a = new Array(arguments.length -  1);
while (G__12060__i < G__12060__a.length) {G__12060__a[G__12060__i] = arguments[G__12060__i + 1]; ++G__12060__i;}
  add_args = new cljs.core.IndexedSeq(G__12060__a,0,null);
} 
return G__12059__delegate.call(this,add_fmt,add_args);};
G__12059.cljs$lang$maxFixedArity = 1;
G__12059.cljs$lang$applyTo = (function (arglist__12061){
var add_fmt = cljs.core.first(arglist__12061);
var add_args = cljs.core.rest(arglist__12061);
return G__12059__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq12029){
...
var G__12032 = cljs.core.first(seq12029__$2);
var seq12029__$3 = cljs.core.next(seq12029__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12030,G__12031,G__12032,seq12029__$3);
}));
...
var seq__12036 = cljs.core.seq(features);
var chunk__12037 = null;
var count__12038 = (0);
var i__12039 = (0);
while(true){
if((i__12039 < count__12038)){
var feature = chunk__12037.cljs$core$IIndexed$_nth$arity$2(null,i__12039);
...
var G__12062 = seq__12036;
var G__12063 = chunk__12037;
var G__12064 = count__12038;
var G__12065 = (i__12039 + (1));
seq__12036 = G__12062;
chunk__12037 = G__12063;
count__12038 = G__12064;
i__12039 = G__12065;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__12036);
if(temp__5735__auto__){
var seq__12036__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__12036__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__12036__$1);
var G__12066 = cljs.core.chunk_rest(seq__12036__$1);
var G__12067 = c__4556__auto__;
var G__12068 = cljs.core.count(c__4556__auto__);
var G__12069 = (0);
seq__12036 = G__12066;
chunk__12037 = G__12067;
count__12038 = G__12068;
i__12039 = G__12069;
continue;
} else {
var feature = cljs.core.first(seq__12036__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__12070 = cljs.core.next(seq__12036__$1);
var G__12071 = null;
var G__12072 = (0);
var G__12073 = (0);
seq__12036 = G__12070;
chunk__12037 = G__12071;
count__12038 = G__12072;
i__12039 = G__12073;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o12041 = temp__5733__auto__;
return (o12041["version"]);
} else {
return null;
}
})() == null);
