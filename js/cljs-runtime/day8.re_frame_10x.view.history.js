...
var G__21564 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","load-epoch","epochs/load-epoch",166872985),id], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21564) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.call(null,G__21564));
...
var all_events = cljs.core.deref((function (){var G__21565 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","all-events-by-id","epochs/all-events-by-id",-1225664812)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__21565) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__21565));
})());
var current_id = cljs.core.deref((function (){var G__21566 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__21566) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__21566));
})());
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4529__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__21567(s__21568){
return (new cljs.core.LazySeq(null,(function (){
var s__21568__$1 = s__21568;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__21568__$1);
if(temp__5735__auto__){
var s__21568__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21568__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__21568__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__21570 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__21569 = (0);
while(true){
if((i__21569 < size__4528__auto__)){
var vec__21571 = cljs.core._nth(c__4527__auto__,i__21569);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21571,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21571,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__21570,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__21577 = (i__21569 + (1));
i__21569 = G__21577;
continue;
} else {
var G__21578 = (i__21569 + (1));
i__21569 = G__21578;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21570),day8$re_frame_10x$view$history$render_$_iter__21567(cljs.core.chunk_rest(s__21568__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21570),null);
}
} else {
var vec__21574 = cljs.core.first(s__21568__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21574,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21574,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__21567(cljs.core.rest(s__21568__$2)));
} else {
var G__21579 = cljs.core.rest(s__21568__$2);
s__21568__$1 = G__21579;
continue;
}
}
} else {
