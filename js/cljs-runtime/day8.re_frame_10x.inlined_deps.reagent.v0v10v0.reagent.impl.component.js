...
if((i < len)){
var k = (ks[i]);
var G__15614 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__15615 = (i + (1));
m = G__15614;
i = G__15615;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15601 = c;
var G__15601__$1 = (((G__15601 == null))?null:G__15601.prototype);
if((G__15601__$1 == null)){
return null;
} else {
return G__15601__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15603 = c;
var G__15603__$1 = (((G__15603 == null))?null:G__15603.prototype);
if((G__15603__$1 == null)){
return null;
} else {
return G__15603__$1.render;
}
})() == null)))));
});
...
var G__15605 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__15605) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.call(null,G__15605));
};
...
while (G__15618__i < G__15618__a.length) {G__15618__a[G__15618__i] = arguments[G__15618__i + 0]; ++G__15618__i;}
  args = new cljs.core.IndexedSeq(G__15618__a,0,null);
} 
...
var G__15606 = c;
var G__15606__$1 = (((G__15606 == null))?null:G__15606.constructor);
if((G__15606__$1 == null)){
return null;
} else {
return G__15606__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__15607 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15608 = c;
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15608);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15607);
}});
...
var renders_15624 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_15625 = cljs.core.first(cljs.core.vals(renders_15624));
...
if((cljs.core.count(renders_15624) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_15624))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_15625)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_15625], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__15613 = o;
goog.object.set(G__15613,cljs.core.name(k),v);
