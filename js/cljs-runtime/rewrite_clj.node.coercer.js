...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__18454 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
...
var comma_18459 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_18460 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__18455){
var vec__18456 = p__18455;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18456,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18456,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_18460,rewrite_clj.node.protocols.coerce(v),comma_18459], null);
