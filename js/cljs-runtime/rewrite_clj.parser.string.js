...
if((c === "\n")){
var G__18483 = escape_QMARK_;
var G__18484 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__18483;
lines = G__18484;
continue;
} else {
buf.append(c);

var G__18485 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__18486 = lines;
escape_QMARK_ = G__18485;
lines = G__18486;
continue;
...
var G__18480 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__18480) : rewrite_clj.node.string_node.call(null,G__18480));
});
...
var G__18481 = cljs.core.re_pattern(regex);
var G__18482 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__18481,G__18482) : rewrite_clj.node.token_node.call(null,G__18481,G__18482));
});
