...
var G__20672 = o;
goog.object.set(G__20672,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__20702__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__20702 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__20703__i = 0, G__20703__a = new Array(arguments.length -  0);
while (G__20703__i < G__20703__a.length) {G__20703__a[G__20703__i] = arguments[G__20703__i + 0]; ++G__20703__i;}
  args = new cljs.core.IndexedSeq(G__20703__a,0,null);
} 
return G__20702__delegate.call(this,args);};
G__20702.cljs$lang$maxFixedArity = 0;
G__20702.cljs$lang$applyTo = (function (arglist__20704){
...
var G__20673 = o;
goog.object.set(G__20673,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__20705__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__20706__i < G__20706__a.length) {G__20706__a[G__20706__i] = arguments[G__20706__i + 0]; ++G__20706__i;}
  args = new cljs.core.IndexedSeq(G__20706__a,0,null);
} 
...
var args = cljs.core.seq(arglist__20707);
...
var G__20674 = props;
var G__20674__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20674,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20674);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20674__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__20674__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__20675 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20675,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__20675;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__20676){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20677__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__20679_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__20679_SHARP_);
}));
} else {
return null;
}
...
var vec__20681 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20681,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20681,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20681,(2),null);
...
var temp__5739__auto___20735 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___20735 == null)){
} else {
var key_20736 = temp__5739__auto___20735;
(jsprops.key = key_20736);
}
...
var temp__5739__auto___20737 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___20737 == null)){
} else {
var key_20738 = temp__5739__auto___20737;
(jsprops.key = key_20738);
}
...
var G__20685 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__20685) : reagent.impl.template.as_element.call(null,G__20685));
} else {
var temp__5739__auto___20739 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___20739 == null)){
} else {
var key_20740 = temp__5739__auto___20739;
(jsprops.key = key_20740);
}
...
var G__20687 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__20687)){
return x;
} else {
...
var len__4736__auto___20741 = arguments.length;
var i__4737__auto___20742 = (0);
while(true){
if((i__4737__auto___20742 < len__4736__auto___20741)){
args__4742__auto__.push((arguments[i__4737__auto___20742]));

var G__20743 = (i__4737__auto___20742 + (1));
i__4737__auto___20742 = G__20743;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20688){
var G__20689 = cljs.core.first(seq20688);
var seq20688__$1 = cljs.core.next(seq20688);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20689,seq20688__$1);
}));
...
var ctx = ({});
var vec__20692 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20692,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20692,(1),null);
...
var G__20695 = (cljs.core.count(argv) - first_child);
switch (G__20695) {
case (0):
