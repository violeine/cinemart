...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13189 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13189(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13190 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13190(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13191 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13191(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13192 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13192(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13193 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13193(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13194 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13194(reader);
}
});
...
var G__13205 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13206 = s.append(c);
c = G__13205;
s = G__13206;
continue;
}
