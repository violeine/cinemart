...
var len__4736__auto___12393 = arguments.length;
var i__4737__auto___12394 = (0);
while(true){
if((i__4737__auto___12394 < len__4736__auto___12393)){
args__4742__auto__.push((arguments[i__4737__auto___12394]));

var G__12395 = (i__4737__auto___12394 + (1));
i__4737__auto___12394 = G__12395;
continue;
} else {
}
break;
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12360_SHARP_){
return (!((cljs.core.meta(p1__12360_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12368__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12372){var _e__9473__auto__ = e12372;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e12374){var _e__9473__auto__ = e12374;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12376 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12377 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12377);

try{var map__12378 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12378__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12376);
}});
...
var temp__5733__auto___12448 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___12448)){
var managed_print_level_12449 = temp__5733__auto___12448;
var _STAR_print_level_STAR__orig_val__12389_12450 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12390_12451 = managed_print_level_12449;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12390_12451);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12382_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12382_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12389_12450);
}} else {
job_fn();
}
