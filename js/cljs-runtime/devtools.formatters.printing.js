...
var len__4736__auto___12400 = arguments.length;
var i__4737__auto___12401 = (0);
while(true){
if((i__4737__auto___12401 < len__4736__auto___12400)){
args__4742__auto__.push((arguments[i__4737__auto___12401]));

var G__12402 = (i__4737__auto___12401 + (1));
i__4737__auto___12401 = G__12402;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12357){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12358,G__12359,seq12357__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12382_SHARP_){
return (!((cljs.core.meta(p1__12382_SHARP_) == null)));
})))){
...
var map__12385 = opts;
var map__12385__$1 = (((((!((map__12385 == null))))?(((((map__12385.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12385.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12385):map__12385);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12385__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12389){var _e__9417__auto__ = e12389;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e12391){var _e__9417__auto__ = e12391;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12393 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12394 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12394);

try{var map__12395 = opts;
var map__12395__$1 = (((((!((map__12395 == null))))?(((((map__12395.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12395.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12395):map__12395);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12395__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12393);
}});
...
var temp__5733__auto___12474 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___12474)){
var managed_print_level_12475 = temp__5733__auto___12474;
var _STAR_print_level_STAR__orig_val__12398_12476 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12399_12477 = managed_print_level_12475;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12399_12477);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12397_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12397_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12398_12476);
}} else {
job_fn();
}
