...
var vec__27709 = cljs.core.rest(expr);
...
var vec__27712 = first__27711;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27712,(0),null);
var form = seq__27710__$1;
...
var G__27715 = x;
var G__27715__$1 = (((G__27715 == null))?null:spec_tools.impl.polish(G__27715));
var G__27715__$2 = (((G__27715__$1 == null))?null:cljs.core.name(G__27715__$1));
if((G__27715__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__27715__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__27716 = x;
var G__27716__$1 = (((G__27716 == null))?null:cljs.core.name(G__27716));
if((G__27716__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__27716__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__27717){
...
var data = map__27718__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27718__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27718__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27718__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27718__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__27720){
...
var data = map__27721__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27721__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27721__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__27723 = data;
var G__27723__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27723,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__27723);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27723__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__27723__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__27727 = form;
var G__27727__$1 = (((G__27727 == null))?null:cljs.core.rest(G__27727));
if((G__27727__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__27727__$1);
}
})();
var G__27728 = m;
var G__27728__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27728,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__27724_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__27724_SHARP_)));
})):G__27728);
var G__27728__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27728__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__27725_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__27725_SHARP_)));
})):G__27728__$1);
var G__27728__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27728__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__27726_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__27726_SHARP_));
})):G__27728__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__27728__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__27729 = (function (){var G__27730 = form;
var G__27730__$1 = (((G__27730 == null))?null:cljs.core.rest(G__27730));
if((G__27730__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__27730__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27729__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27729__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27729__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27729__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__27732 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__27732) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__27733 = form;
var G__27733__$1 = (((G__27733 == null))?null:cljs.core.seq(G__27733));
var G__27733__$2 = (((G__27733__$1 == null))?null:cljs.core.first(G__27733__$1));
if((G__27733__$2 == null)){
return null;
} else {
var fexpr__27734 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__27734.cljs$core$IFn$_invoke$arity$1 ? fexpr__27734.cljs$core$IFn$_invoke$arity$1(G__27733__$2) : fexpr__27734.call(null,G__27733__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq27735){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27735));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__27736){
var vec__27737 = p__27736;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27737,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27737,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__27742){
var map__27743 = p__27742;
var map__27743__$1 = (((((!((map__27743 == null))))?(((((map__27743.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27743.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27743):map__27743);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27743__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27743__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27743__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27743__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__27740_SHARP_){
return cljs.core.map_QMARK_(p1__27740_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__27741_SHARP_){
return cljs.core.contains_QMARK_(p1__27741_SHARP_,x);
});
}),req_keys));
