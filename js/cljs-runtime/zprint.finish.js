...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__16985_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__16985_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__16985_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__16986){
var vec__16987 = p__16986;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16987,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16987,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__16990,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16991__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16991__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16991__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__16995 = (function (){var or__4126__auto__ = color;
...
var fexpr__16994 = (function (){var G__16996 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__16996) : style_map.call(null,G__16996));
})();
return (fexpr__16994.cljs$core$IFn$_invoke$arity$1 ? fexpr__16994.cljs$core$IFn$_invoke$arity$1(G__16995) : fexpr__16994.call(null,G__16995));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__16997){
var vec__16998 = p__16997;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16998,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16998,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16998,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__17001){
var vec__17002 = p__17001;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17002,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17002,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17002,(2),null);
...
var G__17057 = cljs.core.next(ssv);
var G__17058 = (this_ssv == null);
var G__17059 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__17060 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__17057;
doing_nil_QMARK_ = G__17058;
last_elide = G__17059;
out = G__17060;
continue;
}
...
var vec__17009 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17009,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17009,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17009,(2),null);
...
var G__17061 = cljs.core.next(remaining_cvec);
var G__17062 = new_idx;
var G__17063 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__17061;
idx = G__17062;
out = G__17063;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__17016,cursor_vec){
var vec__17017 = p__17016;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17017,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17017,(1),null);
var focus_vec = vec__17017;
...
var vec__17020 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17020,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17020,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__17024){
var vec__17025 = p__17024;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17025,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17025,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__17031,existing_count){
var vec__17032 = p__17031;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17032,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17032,(1),null);
...
return cljs.core.filterv((function (p1__17028_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__17028_SHARP_))));
...
var vec__17038 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17038,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17038,(1),null);
var cvec_element = vec__17038;
if((cvec_element == null)){
var G__17071 = cljs.core.next(cvec_nl);
var G__17072 = (idx + (1));
var G__17073 = start;
var G__17074 = out;
cvec_nl = G__17071;
...
var G__17075 = cljs.core.next(cvec_nl);
var G__17076 = (idx + (1));
var G__17077 = idx;
var G__17078 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__17075;
idx = G__17076;
start = G__17077;
out = G__17078;
...
var G__17080 = cljs.core.next(cvec_nl);
var G__17081 = (idx + (1));
var G__17082 = (idx + (1));
var G__17083 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__17080;
idx = G__17081;
start = G__17082;
out = G__17083;
...
var G__17084 = cljs.core.next(cvec_nl);
var G__17085 = (idx + (1));
var G__17086 = idx;
var G__17087 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__17084;
idx = G__17085;
start = G__17086;
out = G__17087;
...
var G__17088 = cljs.core.next(cvec_nl);
var G__17089 = (idx + (1));
var G__17090 = start;
var G__17091 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__17088;
idx = G__17089;
start = G__17090;
out = G__17091;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__17042_SHARP_,p2__17041_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__17041_SHARP_)){
return cljs.core.reduced(p1__17042_SHARP_);
} else {
return (p1__17042_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__17043,p__17044){
var vec__17045 = p__17043;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17045,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17045,(1),null);
var vec__17048 = p__17044;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17048,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17048,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__17052,cvec,focus_vec){
var map__17053 = p__17052;
var map__17053__$1 = (((((!((map__17053 == null))))?(((((map__17053.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17053.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__17053):map__17053);
var options = map__17053__$1;
var map__17054 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17053__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17054__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17054__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17054__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17051_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__17051_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
