...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__16980_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__16980_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__16980_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__16984){
var vec__16987 = p__16984;
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__16992,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16993__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16993__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16993__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__16997 = (function (){var or__4126__auto__ = color;
...
var fexpr__16996 = (function (){var G__16998 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__16998) : style_map.call(null,G__16998));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__16999){
var vec__17000 = p__16999;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17000,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17000,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17000,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__17003){
var vec__17004 = p__17003;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17004,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17004,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17004,(2),null);
...
var G__17072 = cljs.core.next(ssv);
var G__17073 = (this_ssv == null);
var G__17074 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__17075 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__17072;
doing_nil_QMARK_ = G__17073;
last_elide = G__17074;
out = G__17075;
continue;
}
...
var vec__17010 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17010,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17010,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17010,(2),null);
...
var G__17076 = cljs.core.next(remaining_cvec);
var G__17077 = new_idx;
var G__17078 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__17076;
idx = G__17077;
out = G__17078;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__17024,cursor_vec){
var vec__17025 = p__17024;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17025,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17025,(1),null);
var focus_vec = vec__17025;
...
var vec__17028 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17028,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17028,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__17031){
var vec__17032 = p__17031;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17032,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17032,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__17038,existing_count){
var vec__17039 = p__17038;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17039,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17039,(1),null);
...
return cljs.core.filterv((function (p1__17035_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__17035_SHARP_))));
...
var vec__17048 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17048,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17048,(1),null);
var cvec_element = vec__17048;
...
var G__17092 = cljs.core.next(cvec_nl);
var G__17093 = (idx + (1));
var G__17094 = idx;
var G__17095 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__17092;
idx = G__17093;
start = G__17094;
out = G__17095;
...
var G__17096 = cljs.core.next(cvec_nl);
var G__17097 = (idx + (1));
var G__17098 = (idx + (1));
var G__17099 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__17096;
idx = G__17097;
start = G__17098;
out = G__17099;
...
var G__17100 = cljs.core.next(cvec_nl);
var G__17101 = (idx + (1));
var G__17102 = idx;
var G__17103 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__17100;
idx = G__17101;
start = G__17102;
out = G__17103;
...
var G__17105 = cljs.core.next(cvec_nl);
var G__17106 = (idx + (1));
var G__17107 = start;
var G__17108 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__17105;
idx = G__17106;
start = G__17107;
out = G__17108;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__17052_SHARP_,p2__17051_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__17051_SHARP_)){
return cljs.core.reduced(p1__17052_SHARP_);
} else {
return (p1__17052_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__17053,p__17054){
var vec__17055 = p__17053;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17055,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17055,(1),null);
var vec__17058 = p__17054;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17058,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17058,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__17066,cvec,focus_vec){
...
var options = map__17067__$1;
var map__17068 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17067__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__17068__$1 = (((((!((map__17068 == null))))?(((((map__17068.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17068.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__17068):map__17068);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17068__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17068__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17068__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17065_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__17065_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
