...
while (G__15654__i < G__15654__a.length) {G__15654__a[G__15654__i] = arguments[G__15654__i + 0]; ++G__15654__i;}
  args = new cljs.core.IndexedSeq(G__15654__a,0,null);
} 
...
var G__15626 = o;
goog.object.set(G__15626,day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_prop_value(v));
...
var G__15627 = props;
var G__15627__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15627,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15627);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15627__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__15627__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.set_id_class((function (){var G__15628 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15628,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__15628;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v10v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__15629){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15630__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__15632_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_handle_change(this$,on_change,p1__15632_SHARP_);
}));
} else {
return null;
}
...
var vec__15634 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15634,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15634,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15634,(2),null);
...
var temp__5739__auto___15666 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___15666 == null)){
} else {
var key_15667 = temp__5739__auto___15666;
(jsprops.key = key_15667);
}
...
var temp__5739__auto___15668 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___15668 == null)){
} else {
var key_15669 = temp__5739__auto___15668;
(jsprops.key = key_15669);
}
...
var G__15638 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__15638) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.call(null,G__15638));
} else {
var temp__5739__auto___15670 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___15670 == null)){
} else {
var key_15671 = temp__5739__auto___15670;
(jsprops.key = key_15671);
}
...
var G__15640 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__15640)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__15640)){
return x;
} else {
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15641){
var G__15642 = cljs.core.first(seq15641);
var seq15641__$1 = cljs.core.next(seq15641);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15642,seq15641__$1);
}));
...
break;
default:
var G__15676 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__15676;
continue;
...
var ctx = ({});
var vec__15645 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15645,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15645,(1),null);
...
var G__15648 = (cljs.core.count(argv) - first_child);
switch (G__15648) {
case (0):
