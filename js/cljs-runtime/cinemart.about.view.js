...
cljs.core.chunk_append(b__29175,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.mt-3.py-2.px-3.rounded.mx-2.w-64.flex.text-white","a.mt-3.py-2.px-3.rounded.mx-2.w-64.flex.text-white",-1576484870),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),css,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__29174,css,icon,noti,c__4527__auto__,size__4528__auto__,b__29175,s__29173__$2,temp__5735__auto__){
return (function (){
...
});})(i__29174,css,icon,noti,c__4527__auto__,size__4528__auto__,b__29175,s__29173__$2,temp__5735__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29175),cinemart$about$view$about_page_$_iter__29172(cljs.core.chunk_rest(s__29173__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29175),null);
}
} else {
var noti = cljs.core.first(s__29173__$2);
var css = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cinemart.notification.view.noti_type,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [noti,new cljs.core.Keyword(null,"css","css",1135045163)], null));
var icon = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cinemart.notification.view.noti_type,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [noti,new cljs.core.Keyword(null,"icon","icon",1679606541)], null));
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.mt-3.py-2.px-3.rounded.mx-2.w-64.flex.text-white","a.mt-3.py-2.px-3.rounded.mx-2.w-64.flex.text-white",-1576484870),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),css,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (css,icon,noti,s__29173__$2,temp__5735__auto__){
return (function (){
return re_frame.core.dispatch_sync(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cinemart.notification.events","notify","cinemart.notification.events/notify",-147662311),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"text","text",-1790561697),["this is an ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(noti)].join(''),new cljs.core.Keyword(null,"type","type",1174270348),noti], null)], null));
});})(css,icon,noti,s__29173__$2,temp__5735__auto__))
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [icon,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["w-8","mr-5"], null)], null)], null),["this is an ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(noti)].join('')], null),cinemart$about$view$about_page_$_iter__29172(cljs.core.rest(s__29173__$2)));
}
} else {
return null;
}
