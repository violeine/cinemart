...
var G__18732 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__18732__$1 = (((G__18732 == null))?null:cljs.core.iterate((function (loc){
...
var G__18732__$2 = (((G__18732__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__18732__$1));
var G__18732__$3 = (((G__18732__$2 == null))?null:cljs.core.last(G__18732__$2));
if((G__18732__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__18732__$3);
}
} else {
return zloc;
}
...
var G__18735 = rewrite_clj.zip.move.right(v);
var G__18736 = rewrite_clj.zip.move.up(v);
loc = G__18735;
parent = G__18736;
continue;
} else {
var G__18737 = rewrite_clj.zip.move.right(v0);
var G__18738 = parent;
loc = G__18737;
parent = G__18738;
continue;
...
var G__18739 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__18740 = rewrite_clj.zip.move.up(v);
loc = G__18739;
parent = G__18740;
continue;
} else {
var G__18741 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__18742 = parent;
loc = G__18741;
parent = G__18742;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__18733 = zloc;
var G__18733__$1 = (((G__18733 == null))?null:rewrite_clj.zip.move.down(G__18733));
var G__18733__$2 = (((G__18733__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__18733__$1,k));
if((G__18733__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__18733__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__18734 = rewrite_clj.zip.move.down(zloc);
var G__18734__$1 = (((G__18734 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__18734));
if((G__18734__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__18734__$1);
}
})(),k);
}
});
